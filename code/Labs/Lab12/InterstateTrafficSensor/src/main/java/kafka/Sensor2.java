...
public class Sensor2 {
	...
	@Scheduled(fixedRate = 25800)
		public void car1() {
			...
			SensorRecord sensorRecord = new SensorRecord(licencePlate, car1CameraId);
	...
	@Scheduled(fixedRate = 23900)
		public void car3() {
			...
			SensorRecord sensorRecord = new SensorRecord(licencePlate, car3CameraId);
			sender.send(cameratopic, sensorRecord);
			System.out.println("sending to topic:"+cameratopic+"  "+sensorRecord.cameraId+" "+sensorRecord.licencePlate);
			car3CameraId++;
		if (car3CameraId == 3) {
	...
	@Scheduled(fixedRate = 26100)
		public void car4() {
			...
			SensorRecord sensorRecord = new SensorRecord(licencePlate, car4CameraId);
			sender.send(cameratopic, sensorRecord);
			System.out.println("sending to topic:"+cameratopic+"  "+sensorRecord.cameraId+" "+sensorRecord.licencePlate);
			car4CameraId++;
		if (car4CameraId == 3) {
	...
	@Scheduled(fixedRate = 22900)
		public void car5() {
			...
			SensorRecord sensorRecord = new SensorRecord(licencePlate, car5CameraId);
			sender.send(cameratopic, sensorRecord);
			System.out.println("sending to topic:"+cameratopic+"  "+sensorRecord.cameraId+" "+sensorRecord.licencePlate);
			car5CameraId++;
		if (car5CameraId == 3) {
	...
	@Scheduled(fixedRate = 26700)
		public void car6() {
			...
			SensorRecord sensorRecord = new SensorRecord(licencePlate, car6CameraId);
			sender.send(cameratopic, sensorRecord);
			System.out.println("sending to topic:"+cameratopic+"  "+sensorRecord.cameraId+" "+sensorRecord.licencePlate);
			car6CameraId++;
		if (car6CameraId == 3) {
	...
	@Scheduled(fixedRate = 25900)
		public void car7() {
			...
			SensorRecord sensorRecord = new SensorRecord(licencePlate, car7CameraId);
			sender.send(cameratopic, sensorRecord);
			System.out.println("sending to topic:"+cameratopic+"  "+sensorRecord.cameraId+" "+sensorRecord.licencePlate);
			car7CameraId++;
		if (car7CameraId == 3) {
	...
	@Scheduled(fixedRate = 24200)
		public void car8() {
			...
			SensorRecord sensorRecord = new SensorRecord(licencePlate, car8CameraId);
			sender.send(cameratopic, sensorRecord);
			System.out.println("sending to topic:"+cameratopic+"  "+sensorRecord.cameraId+" "+sensorRecord.licencePlate);
			car8CameraId++;
		if (car8CameraId == 3) {
	...
	@Scheduled(fixedRate = 23200)
		public void car9() {
			...
			SensorRecord sensorRecord = new SensorRecord(licencePlate, car9CameraId);
			sender.send(cameratopic, sensorRecord);
			System.out.println("sending to topic:"+cameratopic+"  "+sensorRecord.cameraId+" "+sensorRecord.licencePlate);
			car9CameraId++;
		if (car9CameraId == 3) {
	...
	@Scheduled(fixedRate = 28500)
		public void car10() {
			...
			SensorRecord sensorRecord = new SensorRecord(licencePlate, car10CameraId);
			sender.send(cameratopic, sensorRecord);
			System.out.println("sending to topic:"+cameratopic+"  "+sensorRecord.cameraId+" "+sensorRecord.licencePlate);
			car10CameraId++;
		if (car10CameraId == 3) {
