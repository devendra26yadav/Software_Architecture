...
public class Client implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		callRemoteService("http://localhost:8085/name", "nobody", "nobody");
		callRemoteService("http://localhost:8085/phone", "john", "john");
		callRemoteService("http://localhost:8085/phone", "frank", "frank");
		callRemoteService("http://localhost:8085/salary", "john", "john");
		callRemoteService("http://localhost:8085/salary", "frank", "frank");
		callRemoteService("http://localhost:8085/sensitive", "frank", "frank");
	}
